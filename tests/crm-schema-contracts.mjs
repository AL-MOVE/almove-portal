...
assert.deepEqual(normalizarClienteLegado({
  ...
  email: 'cristiana@example.pt', nif: '123456789', morada: 'Rua do Movimento, 17', servicoAtual: 'PT - 2x45 min', precoPersonalizado: '89.5', diaPagamento: 8, metodoPagamento: 'MB Way', notas: 'Teste'
}), {
  id: 'C017', nome: 'Cristiana de Almeida Moreira', estado: 'Ativo', contacto: '912345678',
  email: 'cristiana@example.pt', nif: '123456789', morada: 'Rua do Movimento, 17', servicoAtual: 'PT - 2x45 min', precoPersonalizado: 89.5, diaPagamento: 8, metodoPagamento: 'MB Way', notas: 'Teste'
});
