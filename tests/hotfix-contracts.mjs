...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "54"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v54/, 'A cache PWA deve avançar para v54');
...
console.log('Contratos do portal v54 validados.');
