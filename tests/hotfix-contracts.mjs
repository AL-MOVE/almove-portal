...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "58"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v58/, 'A cache PWA deve avançar para v58');
...
console.log('Contratos do portal v58 validados.');
