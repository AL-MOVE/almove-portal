...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "68"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v68/, 'A cache PWA deve avançar para v67');
