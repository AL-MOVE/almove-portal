...
assert.match(html, /id="perfilAvatar"/, 'O cliente deve poder escolher e personalizar o avatar');
...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "53"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v53/, 'A cache PWA deve avançar para v53');
assert.match(sw, /\/js\/avatar-studio\.js/, 'O editor de avatar deve estar disponível offline');
...
console.log('Contratos do portal v53 validados.');
