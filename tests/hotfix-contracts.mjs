...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "55"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v55/, 'A cache PWA deve avançar para v55');
...
console.log('Contratos do portal v55 validados.');
