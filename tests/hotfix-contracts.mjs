...
assert.match(html, /VERSAO_CLIENTE_PORTAL = "59"/, 'O cliente deve identificar a versão da atualização');
...
assert.match(sw, /almove-portal-v59/, 'A cache PWA deve avançar para v59');
...
console.log('Contratos do portal v59 validados.');
